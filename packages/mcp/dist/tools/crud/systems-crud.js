...
export function registerSystemCrudTools(server, kinoFetch) {
    ...
    server.tool('update_system', 'Actualiza propiedades de un sistema existente en Kino (nombre, color, ícono, propósito, etc.)', {
    ...
    server.tool('delete_system', 'Desactiva (soft-delete) un sistema en Kino. No puede eliminarse el Inbox.', {
