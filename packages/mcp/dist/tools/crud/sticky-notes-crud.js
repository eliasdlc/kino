...
export function registerStickyNoteCrudTools(server) {
    ...
    server.tool('create_sticky_note', 'Crea una nota adhesiva (sticky note) anclada a una carpeta o a una página en Kino. Debes indicar folderId O pageId.', {
    ...
    server.tool('update_sticky_note', 'Actualiza el título, contenido o color de una nota adhesiva en Kino', {
    ...
    server.tool('delete_sticky_note', 'Elimina una nota adhesiva de Kino', {
