...
export function SystemDesignShell() {
  // Sin backend en esta página: las queries que ningún specimen siembra se
  // quedan cargando y las cards renderizan sin ese metadato.
  const [client] = useState(() => makeTestConvexClient() as unknown as ConvexReactClient);
