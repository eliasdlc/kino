...
function seedBudget(tasks: ReturnType<typeof seededTask>[], limit: number) {
  return [
    seedQuery(api.tasks.todayPlan, tasks as never),
...
function seedRitual() {
  ...
  return [
    ...
    seedQuery(api.energy.weeklyRitual, {
      ...
      >
        <SpecimenGrid cols={2}>
          ...
          <Specimen label="tight" hint="45/50 · 90 %" className="items-stretch">
            <div className="w-full">
              <Seeded stubs={seedBudget(highs(9, 3), 50)}>
                <EnergyBudgetBar />
              </Seeded>
            </div>
          </Specimen>
          ...
          <Specimen label="tight · presupuesto justo" hint="50/50 · el día está lleno" className="items-stretch">
            <div className="w-full">
              <Seeded stubs={seedBudget(highs(10), 50)}>
                <EnergyBudgetBar />
              </Seeded>
            </div>
          </Specimen>
          ...
          <Specimen label="over" hint="60/50 · sobregiro de 10" className="items-stretch">
            <div className="w-full">
              <Seeded stubs={seedBudget(highs(12, 2), 50)}>
                <EnergyBudgetBar />
              </Seeded>
            </div>
          </Specimen>
