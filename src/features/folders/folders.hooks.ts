...
/** Las subcarpetas con sus cuentas, tal como las pinta el servidor. */
export type FolderChildrenTransport = FunctionReturnType<typeof api.folders.children>;
...
export function useFolderChildren(folderId: string, initialData?: FolderChildrenTransport) {
  return useConvexQuery(api.folders.children, { id: folderId }, { initialData });
}
